...
# -*- coding: utf-8 -*-
#
# fluquid-lib documentation build configuration file, created by
...
htmlhelp_basename = 'fluquid-libdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'fluquid-lib.tex',
     u'fluquid-lib Documentation',
